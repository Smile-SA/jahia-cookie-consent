...
<fmt:message key="jnt_acceptCookiesMessage.buttonText.default" var="buttonTextDefault"/>
<fmt:message key="jnt_acceptCookiesMessage.message.default" var="messageDefault"/>
<fmt:message key="jnt_acceptCookiesMessage.knowMoreLinkText.default" var="knowMoreLinkTextDefault"/>
